...
def _build_system_prompt(body):
    ...
    return (
        ...
        f'— never just a chat summary of numbers. If no skill tool is '
        f'listed, or you need to correct a single value afterwards, use '
        f'set_value for just that correction. If they pick B, go one '
        f'screen at a time, narrating what each one does.\n'
